...
public class UserService implements UserDetailsService {
    ...
    public User findByUsername(String username) {
        // First try to find active user to avoid duplicates
        Optional<User> activeUserOpt = userRepository.findActiveByEmail(username);
        if (activeUserOpt.isPresent()) {
            return activeUserOpt.get();
        }
        
        // Fallback to any user with that email
